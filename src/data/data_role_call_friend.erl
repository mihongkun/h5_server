...
get(A) ->
 format_util:log(error,[{tag, cfg_error},{module,?MODULE},{line,?LINE},{sid,erlang:get(sid)},{pid,self()}], "data_role_call_friend:get(~p) not_match", [A]),
 not_match.
...
all() ->[data_role_call_friend:get(ID) || ID<-id_list()].
